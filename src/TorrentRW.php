...
class TorrentRW
{
     ...
     * @param string|array $meta announce url or meta informations (optional)
     ...
     * @param null|string $comment comment (optional, if omitted it's a getter)
     ...
     * @param null|string $name name (optional, if omitted it's a getter)
     ...
     * @param null|boolean $private is private or not (optional, if omitted it's a getter)
     ...
     * @param null|string|array $urls webseed or webseeds mirror list (optional, if omitted it's a getter)
     ...
     * @param null|string|array $urls httpseed or httpseeds mirror list (optional, if omitted it's a getter)
     ...
     * @param integer|null $precision size precision (optional, if omitted returns sizes in bytes)
     ...
     * @param integer|null $precision size precision (optional, if omitted returns size in bytes)
     * @return mixed file(s) size
     */
     ...
     * @param float|int $timeout read timeout in seconds (optional, default to self::timeout 30s)
     ...
     * @param null|string $filename name of the file (optional)
    ...
    /** Get magnet link
     * @param boolean $html html encode ampersand, default true (optional)
     ...
     * @param bool $message boolean return error message or not (optional, default to false)
     ...
     * @return array first announce url
     */
